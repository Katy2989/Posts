const onResponse = (res) =>{
    ...
    class Api {
        ...
        getPostList(page, limit){
          ...
          {  
          headers: {authorization: this._token}, }).then(
          onResponse);
        }
        ...
        getUserInfo() {
          ...
          search(searchQuery, page, limit){
            ...
            { 
              headers: {authorization: this._token}, }).then(onResponse);
          }
          ...
          setUserInfo(dataUser){
            ...
            addPost(values) {
          // console.log(`${this._headers}`, "hghuguh");
              console.log(JSON.stringify(values));
                return fetch(`${this._baseUrl}/posts`, {
                  method: "POST",
                  headers: {authorization: this._token,
                  "Content-type": "application/json"},
                  body: JSON.stringify(values)}).then(onResponse);
              }
